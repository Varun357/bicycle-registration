...
$page_primary_ids = [];
if ($primary_ids_result->num_rows > 0) {
...
<head>
    ...
    <style>
        ...
        /* MODIFIED: CSS for responsive table */
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($group['members'] as $member): ?>
                                <tr>
                                    <td data-label="Rider ID"><?php echo htmlspecialchars($member['unique_rider_id']); ?></td>
                                    <td data-label="Name"><?php echo htmlspecialchars(trim($member['first_name'] . ' ' . $member['last_name'])); ?></td>
                                    <td data-label="Date of Birth"><?php echo date("d M Y", strtotime($member['dob'])); ?></td>
                                    <td data-label="Sex"><?php echo htmlspecialchars($member['sex']); ?></td>
                                    <td data-label="Blood Group"><?php echo htmlspecialchars($member['blood_group']); ?></td>
                                    <td data-label="Blood Donation"><?php echo htmlspecialchars($member['interested_in_blood_donation']); ?></td>
                                    <td data-label="T-Shirt"><?php echo htmlspecialchars($member['tshirt_size']); ?></td>
                                    <td data-label="WhatsApp No."><?php echo htmlspecialchars($member['member_whatsapp']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
